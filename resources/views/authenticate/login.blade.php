        ...
        <form action="../in" class="justify-center items-center" method="post" id="form">
            ...
            <table class="mt-4 table-fixed">
                <tr class="m-5">
                    ...
                    <td>
                        <input type="text" class="grow min-w-105 h-10 text-black bg-white px-2" id="email" name="email" placeholder="example@gmail.com">
                        <span id="uidError" class="text-red-700"></span>
                    </td>
                </tr>
                <tr>
                    <td><label for="password" class="text-blue-600 w-30 text-xl my-5 px-5">Password:</label></td>
                    <td>
                        <input type="password" class="grow min-w-105 h-10 text-blue-800 mt-5 bg-red-100" name="password" id="password">
                        <span id="pwErr" class="text-red-700"></span>
                    </td>
                </tr>
                <tr>
